...
export default function VancouverToBangkokPage() {
  return (
    <section className="container-shell py-14">
      <h1 className="heading-xl text-slate-900">Cheap Flights from Vancouver to Bangkok</h1>
      <p className="section-subtitle mt-4 max-w-3xl">
        Compare YVR to BKK prices and choose the best stopover combinations for your trip.
      </p>
      <div className="mt-8">
        <HeroSearch />
      </div>
      <div className="mt-8 grid gap-5 md:grid-cols-2">
        ...
        <article className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="body-base mt-3 text-slate-600">
            November-February is peak season; shoulder months can offer lower fares.
          </p>
      ...
      <a
        href={withMarker("https://www.aviasales.com/search/YVR0109BKK1", marker)}
        target="_blank"
