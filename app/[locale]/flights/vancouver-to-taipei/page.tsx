...
export default function VancouverToTaipeiPage() {
  return (
    <section className="container-shell py-14">
      ...
      <a href="https://www.aviasales.com/search/YVR0109TPE1?marker=526748" target="_blank" rel="noopener noreferrer sponsored" className="mt-8 inline-block rounded-full bg-sky-500 px-5 py-3 font-semibold text-white hover:bg-sky-600">
